...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/vedant/code/project/utopia/frontend/social-media-app/src/prisma/auth",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "fdebd7916070a7e1a5a8c31b3db533dce8fe534933d656cac299dbebc4432191",
  "copyEngine": true
}
...
path.join(process.cwd(), "src/prisma/auth/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
