...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/vedant/code/project/utopia/frontend/social-media-app/src/auth",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "9edc9812ef4eb415242a764937d17758f72d1fa0b19d1244d93279233ae58d6a",
  "copyEngine": true
}
...
path.join(process.cwd(), "src/auth/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/auth/schema.prisma")
