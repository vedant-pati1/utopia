...
export type VerificationRequest =
  $Result.DefaultSelection<Prisma.$VerificationRequestPayload>;
...
export namespace Prisma {
  ...
  */
      ...
      VerificationRequest: {
        ...
        operations: {
          ...
          count: {
            ...
            result:
              | $Utils.Optional<VerificationRequestCountAggregateOutputType>
              | number;
          };
        };
      };
  ...
  type VerificationRequestGetPayload<
    S extends boolean | null | undefined | VerificationRequestDefaultArgs,
  > = $Result.GetResult<Prisma.$VerificationRequestPayload, S>;

  type VerificationRequestCountArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = Omit<
  ...
  > {
    ...
    ): Prisma__VerificationRequestClient<
      $Result.GetResult<
  ...
  export type VerificationRequestScalarWhereWithAggregatesInput = {
    ...
    expires?:
      | DateTimeWithAggregatesFilter<"VerificationRequest">
      | Date
      | string;
    createdAt?:
      | DateTimeWithAggregatesFilter<"VerificationRequest">
